...
<div id="editmodal-category" class="modal">
    <div class="content-category o-50">
        <div>
            ...
            <ul class="pt-1 mb-2">
                <li class="p-1 pt-1 font-xl">
                    <h1 id="title" class="modal-title talign-c font-xl ls-1 text-bg">{{ __('Add new category') }}</h1>
                </li>
                <li class="p-1 font-xl">
                    <form id="editcategory_form" action="{{ url('/category_update') }}" method="POST">
                        ...
                        <ul class="pt-1 mb-2">
                            ...
                            <li class="p-1 pt-3 font-xl">
                                <input type="text" name="categoryname" id="category_name" placeholder="Category name" required>
                            </li>
                            <li class="p-1 font-xl">
                                <input type="text" name="category_parrent" id="category_parrent"  placeholder="Parent catagory name" required>
                            </li>
                            <li class="p-1 font-xl">
                            ...
                            <li class="p-1 font-xl">
                                <input type="text" name="category_short_description" id="category_short_description" 
                                    placeholder="Short description catagory name" required>
                            </li>
                            <li class="p-1 font-xl">
                                <input type="number" name="category_sequence" id="category_sequence"  placeholder="Catagory sequence" required>
                            </li>
                            <li class="p-1 font-xl">
                                <div class="element">
                                    <label class="font-lg text-secondary ls-1" for="start_date">Start Date -</label>
                                    <input class="ml-1" type="date" id="category_start_date" name="category_start_date" required>
                                </div>
                            </li>
                            <li class="p-1 font-xl talign-c">
                                <div class="element">
                                    <label class="font-lg text-secondary ls-1" for="end_date">End Date -</label>
                                    <input class="ml-1" type="date" id="category_end_date" name="category_end_date" required>
