  ...
  <ul class="menu ">
    <li class="list bg-hover-sidebar-bg-light-2 p-1 font-sm active">
      <a href="{{url('redirect')}}" class="link">
        <svg version="1.1" class="svg p-1 br-sm mr-2 bg-sidebar-bg-light-5 bg-hover-bg-light-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" viewBox="0 0 20 20">
