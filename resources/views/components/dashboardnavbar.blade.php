<nav class="navbar-bg">
    <div class="logo">
        ...
        <div><form action="#" method="post" class="display-f" x-data>
            @csrf
            <input type="text" name="input_search" id="input_search" class="ls-2 fw-300 text-secondary  p-1 pl-3 br-sm" placeholder="Search here...">
        ...
        <ul class="dropdown">
            <li class="ml-1 mr-2">
                ...
                <button id="button_user_small" class="btn-secondary br-xs"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" viewBox="0 0 20 20">
            ...
            <div class="dropdown-content bg-sidebar-bg-light-2 font-sm">
