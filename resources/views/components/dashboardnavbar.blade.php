    ...
    <div class="logo">
        ...
        <ul class="dropdown">
            ...
            <div class="dropdown-content bg-secondary-light-4 font-lg">
                <a class="p-1" href="{{ route('profile.show') }}">{{__('Profile')}} <img class="float-r" src="/images/user.svg" alt="user_icon"></a>
                <a class="p-1" href="{{ route('logout') }}">{{__('Logout')}} <img class="float-r" src="/images/exit.svg" alt="user_icon"></a>
            </div>
            {{-- end dropdown --}}
            </li>
        </ul> 
